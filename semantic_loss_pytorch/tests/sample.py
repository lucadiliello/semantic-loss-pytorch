...
from py3psdd import DataSet,Prior,DirichletPrior,UniformSmoothing

k = 50 # number of training sets
Ns = range(8,13) # dataset sizes
vtree_filename = "py3psdd/tests/examples/example.vtree"
sdd_filename = "py3psdd/tests/examples/example.sdd"
